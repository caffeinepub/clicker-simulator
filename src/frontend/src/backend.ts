...
export class Backend implements backendInterface {
    ...
    async buyUpgrade(arg0: string, arg1: bigint, arg2: bigint, arg3: string): Promise<{
        __kind__: "ok";
        ok: PlayerState;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.buyUpgrade(arg0, arg1, arg2, arg3);
    ...
    async claimPassive(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.claimPassive();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async click(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.click();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async rebirth(): Promise<{
        ...
        if (this.processError) {
            try {
                const result = await this.actor.rebirth();
